...
A Transformada de Fourier, ou \textit{Fast Fourier Transform} em inglês, é segundo \cite{Goncalves2004}, uma ferramenta matemática que realiza a transição entre as variáveis tempo e frequência de sinais. Ela é, sem dúvida, uma descoberta muito importante no campo computacional em virtude da grande economia de processamento que proporciona, pois a transformada rápida de fourier diminui o tempo de processamento em aplicações de diferentes naturezas, tais como:  resolução de equações diferenciais, equações integrais, problemas inversos, processamento de sinal, etc.
%TODO incluir mais alguma informação sobre o uso da FFT no PRESS

\subsection{Cadeia de Markov}
Uma Cadeia de Markov ́é um tipo especial de processo estocástico que possui a chamada propriedade markoviana . Um processo estocástico tem a propriedade markoviana se os estados anteriores do processo são irrelevantes para a predição dos próximos estados, desde que o estado atual seja conhecido. 
...
HMM \textit{(Hidden Markov Model)} é um modelo estatístico que difere da cadeia de Markov clássica pelo fato de que seus parâmetros são desconhecidos. Logo, o desafio deste processo estocástico é justamente a determinação de seus parâmetros ocultos a partir dos seus parâmetros observáveis. E estes últimos por sua vez, retroalimentam o sistema, podendo ser usados para novas análises. É um modelo bastante apropriado para o processo de reconhecimento de padrões. HMM é uma ferramenta para representar uma distribuição de probabilidades sobre uma sequência de observações.
...
Dentre os trabalhos relacionados, foi possível encontrar uma grande variedade de abordagens para a questão da elasticidade. Tão diversa quanto os propósitos destes trabalhos. Podemos notar uma preocupação geral com a questão do SLO, e este é justamente um dos desafios ao se automatizar o processo de alocação e consolidação de recursos. Alguns autores optaram por uma abordagem mais conservadora, onde a superestimação era preferível em face da possibilidade de uma otimização, com o objetivo de garantir o SLO. Também vimos alguns que optaram por técnicas puramente lineares em seus processos de predição, como medida de garantir o desempenho em tempo de execução, nestes casos estratégias para garantir o SLO estavam presentes. Naquelas abordagens mais ousadas, vimos o emprego de múltiplas técnicas de predição, e algumas soluções bastante robustas.

Podemos ver que soluções mistas de elasticidade têm um bom apelo, uma vez que se pode utilizar uma para garantir os limites para a outra, e assim certificar-se de que o acordo de nível de serviço não seja quebrado. E no campo dos modelos probabilísticos utilizados, notamos um grande uso daqueles categorizados como autoregressivos. No entando, estes não apresentaram os melhores resultados. Neste ponto, uma surpresa bastante interessante foram as implementações que se utilizaram de cadeias de Markov e outras soluções derivadas desta. Estas apresentaram um tempo de processamento bastante aceitável, e no caso do modelo oculto de Markov, seus resultados foram surpreendentes do ponto de vista de exatidão das predições. Estes resultados nos levam a considerar fortemente que nosso modelo seja testado com ARIMA e HMM.
...
Estudo e escolha de ferramentas para desenvolvimento e avaliação 		& X &   &   &   &   & 			\\ \hline
Identificação dos modelos probabilísticos								& X &   &   &   &   &			\\ \hline
Modelagem da solução			 										& X & X &   &   &   &			\\ \hline
Definir estratégia para coleta dos dados								&   & X &   &   &   & 			\\ \hline
Desenvolvimento do módulo de captura 									& 	& X &	&   &   &			\\ \hline
Testes e avaliação do módulo de captura 								& 	& X & 	& 	& 	&  		   \\ \hline
Escrita do artigo														& 	& X & X & X & X & X			\\ \hline
Desenvolvimento do módulo de tratamento dos dados						&   &   & X &   &   & 			\\ \hline
Testes e avaliação do módulo de tratamento dos dados					& 	& 	& X	& 	& 	& 		   \\ \hline
Desenvolvimento do módulo de modelos probabilísticos					& 	& 	& X	& X &	&  			\\ \hline
Testes e avaliação do módulo de modelos probabilísticos				& 	& 	& 	& X & 	& 		   \\ \hline
Desenvolvimento do módulo de avaliação de precisão						&	&	&	& X & X &  		   \\ \hline
Testes e avaliação do módulo de avaliação de precisão					& 	& 	& 	& 	& X	& 		   \\ \hline
Preparação da apresentação												& 	&   &   &   & X & X			\\ \hline
Desenvolvimento do módulo de exportação								& 	& 	& 	& 	& 	& X		   \\ \hline
Testes e avaliação do módulo de exportação								& 	& 	& 	& 	& 	& X		   \\ \hline
